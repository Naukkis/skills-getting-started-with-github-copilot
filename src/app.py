...
activities = {
    ...
    "Art Club": {
        "description": "Explore various art mediums and express creativity through painting and drawing",
    ...
    "Debate Club": {
        "description": "Hone public speaking and critical thinking through debate competitions",
